...
namespace RPGClasses
{
    ...
    /// </summary>
    public class OneHandedWeapon : WeaponAbstract, HandheldInterface
    {
        /// <summary>
        /// Builds an OneHandedWeapon Object.  For parameter descriptions, see GearAbstract.
        /// </summary>
        ...
        /// <summary>
        /// Equips 'this' OneHandedWeapon object to a Hero.
        /// </summary>
        ...
        public void EquipItem(Hero heroToEquip, Hero.Hand handToEquip)
        {
            ...
            // Otherwise, unequip the handToBeEquipped
            ...
            // Otherwise, unequip the item from the handToEquip.
            else
            {
