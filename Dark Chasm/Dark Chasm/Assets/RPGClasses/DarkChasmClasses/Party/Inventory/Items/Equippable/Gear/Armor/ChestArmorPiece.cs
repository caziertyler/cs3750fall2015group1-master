...
namespace RPGClasses
{
    ...
    /// </summary>
    public class ChestArmorPiece : GearAbstract
    {

        /// <summary>
        /// Builds a ChestArmorPiece Object.  For parameter descriptions, see GearAbstract.
        /// </summary>
        ...
        public ChestArmorPiece
            (
                int Id, string Name, int Value, int StrengthBonus = 0, int PhysicalDamageBonus = 0,
            ...
            (
                Id, Name, Value, StrengthBonus, PhysicalDamageBonus, PhysicalDefenseBonus, CriticalStrikeBonus, HpBonus,
        ...
        /// <summary>
        /// Equips 'this' ChestArmorPiece object to a Hero.
        /// </summary>
        ...
        public override void EquipItem(Hero heroToEquip)
        {
            ...
            heroToEquip.Equipment.Chest.UnequipItem();
            heroToEquip.Equipment.Chest = this;
        ...
        public override void UnequipItem()
        {
            ...
            {
                EquippedHero.Equipment.Chest = GearList.GetChestPieceList()["None"];
                EquippedHero = null;
                IsEquipped = false;
            }
        }
