...
namespace RPGClasses
{
    ...
    /// </summary>
    public class LegsArmorPiece : GearAbstract
    {

        /// <summary>
        /// Builds a LegsArmorPiece Object.  For parameter descriptions, see GearAbstract.
        /// </summary>
        ...
        /// <summary>
        /// Equips 'this' LegsArmorPiece object to a Hero.
        /// </summary>
        ...
        public override void EquipItem(Hero heroToEquip)
        {
            ...
            heroToEquip.Equipment.Legs.UnequipItem();
            heroToEquip.Equipment.Legs = this;
        ...
        public override void UnequipItem()
        {
            ...
            {
                EquippedHero.Equipment.Legs = GearList.GetLegsPieceList()["None"];
                EquippedHero = null;
                IsEquipped = false;
            }
        }
