...
namespace RPGClasses
{
    ...
    /// <summary>
    /// Provides Bonuses/Weaknesses to a Hero object.
    /// </summary>
    public class FeetArmorPiece : GearAbstract
    {

        /// <summary>
        /// Builds a FeetArmorPiece Object.  For parameter descriptions, see GearAbstract.
        /// </summary>
        ...
        /// <summary>
        /// Equips 'this' FeetArmorPiece object to a Hero.
        /// </summary>
        ...
        public override void EquipItem(Hero heroToEquip)
        {
            ...
            heroToEquip.Equipment.Feet.UnequipItem();
            heroToEquip.Equipment.Feet = this;
        ...
        public override void UnequipItem()
        {
            ...
            {
                EquippedHero.Equipment.Feet = GearList.GetFeetPieceList()["None"];
                EquippedHero = null;
                IsEquipped = false;
            }
        }
