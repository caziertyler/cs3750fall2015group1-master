...
namespace RPGClasses
{
    ...
    /// </summary>
    public class ArmsArmorPiece : GearAbstract
    {

        /// <summary>
        /// Builds an ArmsArmorPiece Object.  For parameter descriptions, see GearAbstract.
        /// </summary>
        ...
        /// <summary>
        /// Equips 'this' ArmsArmorPiece object to a Hero.
        /// </summary>
        ...
        public override void EquipItem(Hero heroToEquip)
        {
            ...
            heroToEquip.Equipment.Arms.UnequipItem();
            heroToEquip.Equipment.Arms = this;
        ...
        public override void UnequipItem()
        {
            ...
            {
                EquippedHero.Equipment.Arms = GearList.GetArmsPieceList()["None"];
                EquippedHero = null;
                IsEquipped = false;
            }
        }
