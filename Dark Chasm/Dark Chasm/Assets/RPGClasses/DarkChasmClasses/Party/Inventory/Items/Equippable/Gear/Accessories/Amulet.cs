...
namespace RPGClasses
{
    ...
    /// </summary>
    public class Amulet : GearAbstract
    {

        /// <summary>
        /// Builds an Amulet Object. For parameter descriptions, see GearAbstract.
        /// </summary>
        ...
        public Amulet
            (
                // ItemAbstract
                int Id, string Name, int MoneyValue,

                // GearItemAbstract
                int StrengthBonus = 0, int PhysicalDamageBonus = 0,
        ...
        /// <summary>
        /// Equips 'this' Amulet object to a Hero.
        /// </summary>
        ...
        public override void EquipItem(Hero heroToEquip)
        {
            ...
            heroToEquip.Equipment.Amulet.UnequipItem();
            heroToEquip.Equipment.Amulet = this;
        ...
        public override void UnequipItem()
        {
            ...
            {
                EquippedHero.Equipment.Amulet = GearList.GetAmuletList()["None"];
                EquippedHero = null;
                IsEquipped = false;
            }
        }
